...
Every article must clear one standard:

> **True. Useful / actionable. Clear.**

**Reputation is the quality of the work we do.** The writing has to be high quality, useful, and
clear. If it isn't all three, it doesn't ship.
...
**True**
- Is every fact, figure, and rule true and verified against a primary source (CMS / SSA / official)?

**Useful**
- How can we make this *incredibly* useful? What does the reader walk away able to do or decide?
- What do people need right now? What are they actually asking for?

**Actionable**
- How can we make it more actionable? Are there clear, concrete next steps the reader can take?

**Clear**
- How can we make it easier to understand and simpler? Plainer words, shorter sentences, one idea at
  a time.
- Signal over noise: what can we cut? Is every section pulling its weight?

**Reader-focused**
- Is the lens on the reader the whole way through?
- Have we primed them at the top so they immediately know they're in the right place?
